...
class SubmissionCreator(object):
    ...
    def create_submission(self, df_test, fname_submission, prediction_dict):
        df = df_test
...
prediction_dict = submission_creator.create_prediction_dict(
    "model/vwdata_test.vwtxt", "model/vwdata.predict.txt")
submission_creator.create_submission(
    df_test, "submission/p.csv", prediction_dict)
